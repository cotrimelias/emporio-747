...
function SearchPage({
  ...
  return (
    <Layout>
      <h1 className={visuallyHidden}>Resultados da Pesquisa</h1>
      <div className={main}>
          ...
          <div className={sortSelector}>
            <label>
              ...
              >
                ...
                <option value="CREATED_AT">Novos itens</option>
                <option value="BEST_SELLING">Em alta</option>
              </select>
            </label>
        ...
        >
          {isFetching ? (
            <p className={progressStyle}>
              <Spinner aria-valuetext="Searching" /> Procurando
